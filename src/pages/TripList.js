  ...
  return (
    <Container>
                  ...
                  <tbody>
                    {trips.map((trip) => (
                      <tr key={trip._id}>
                        ...
                        <td>
                          {trip.driver_id ? trip.driver_id.name : "Unassigned"}
                        </td>
      ...
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
        ...
        <Modal.Body>
          Are you sure you want to delete this trip from {tripToDelete?.origin}{" "}
          to {tripToDelete?.destination}? This action cannot be undone.
        </Modal.Body>
        <Modal.Footer>
